...
Addon (IMPLEMENTATI) - Sono prodotti/materiali vendibili separatamente che si agganciano a un prodotto principale - Esempio: Bottiglia Grey Goose 750ml → max 4 addon - Relazione: Product → ProductAddon → ProductAddonItem → Product
