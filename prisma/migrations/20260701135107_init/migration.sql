...
-- CreateIndex
CREATE UNIQUE INDEX "product_addons_product_id_group_id_key" ON "product_addons"("product_id", "group_id");
...
-- AddForeignKey
ALTER TABLE "addon_groups" ADD CONSTRAINT "addon_groups_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "addon_group_items" ADD CONSTRAINT "addon_group_items_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "addon_groups"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "addon_group_items" ADD CONSTRAINT "addon_group_items_addon_product_id_fkey" FOREIGN KEY ("addon_product_id") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "product_addons" ADD CONSTRAINT "product_addons_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "addon_groups"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
